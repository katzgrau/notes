...
<link href="<?= base_url() ?>public/themes/metamorphenergy/styles.css" rel="stylesheet" type="text/css" media="screen" />
</head>
<body>
<div id="content">
			...
			<div class="title_back">	
     		<ul>
					<?php foreach( $files as $file ): ?>
						<li class="sub"><a href="<?= generate_uploaded_file_url( base_url(), $site_name, $file ) ?>"><?= $file->orig_name ?></a></li>
					<?php endforeach; ?>			
	        </ul>
		  </div>
		  <?php endif; ?>
			...
			<div class="title_back">	
     		<ul>
				<?php foreach( $links as $link ): ?>
					<li class="sub"><a href="<?= $link->url ?>" target="_blank"><?= $link->title ?></a></li>
				<?php endforeach; ?>		
	        </ul>
			</div>
		  <?php endif; ?>
				...
				<table style="border-collapse:collapse; width:100%;" border="0">
					<tr>
						<td>
							...
							Site Name: <br/><input name="site_name" style="width:200px;" onclick="if(this.value=='Site Name') { this.value=''; }" value="Site Name" /><br />
							
							Password: <br /><input id="password" name="password"  style="width:200px;" type="password" value=""/></p><br/>
							<input class="button" type="submit" value="Login" style="width:60px; float:right;" />
