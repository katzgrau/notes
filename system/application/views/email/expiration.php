...
<font face="Georgia">
<h1>Your account with <?= config_item('company_name') ?> is about to expire!</h1>
...
<p>
	You can renew your account at <a href="<?= config_item('base_url') ?>home/renew"><?= config_item('base_url') ?>home/renew</a>. 
