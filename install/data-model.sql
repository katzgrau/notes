...
--
-- Host: localhost
-- Generation Time: Sep 10, 2009 at 11:54 PM
...
--
-- Creation: Sep 10, 2009 at 11:49 PM
--
...
--
-- Creation: Sep 10, 2009 at 11:51 PM
--
...
CREATE TABLE IF NOT EXISTS `renews_pending` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `sales_persons` (`username`, `password`, `created`) VALUES ('admin', 'admin', '0000-00-00 00:00:00');
...
ALTER TABLE `hits`
  ADD CONSTRAINT `hits_ibfk_1` FOREIGN KEY (`site_id`) REFERENCES `sites` (`id`) ON DELETE CASCADE;
